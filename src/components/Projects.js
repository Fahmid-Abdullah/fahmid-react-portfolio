              ...
              <div>
                  ...
                  <p className='project-text'>
                      {project.description.split('\n').map((text, index) => {
                          if (text.startsWith("Check it Out:")) {
